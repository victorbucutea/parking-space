...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { deviceid: @sensor.deviceid, installation_date: @sensor.installation_date, snapshot: @sensor.snapshot, title_message: @sensor.title_message } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { deviceid: @sensor.deviceid, installation_date: @sensor.installation_date, snapshot: @sensor.snapshot, title_message: @sensor.title_message } }
